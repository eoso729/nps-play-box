...
import org.example.signer.xml.PaymentActivationXmlGenerator;
...
public class PaymentActivationService {
    ...
    public Map<String, String> executePaymentActivation(PaymentActivationRequestDto requestDto) throws Exception {
        ...
        PaymentActivation paymentActivation = PaymentActivationXmlGenerator.generate(requestDto, newMsgId,endToEndId);

        // Marshal JAXB object to Document
        Document doc = XmlUtils.marshalToDocument(paymentActivation);
        XmlUtils.writeDocumentToFile(doc, "payment_activation_generated.xml");
        ...
        XmlUtils.writeDocumentToFile(doc, "payment_activation_signed.xml");

        // Encrypt the sensitive data in the signed document
        Encrypter.encrypt(doc, publicKey, "CdtrPmtActvtnReq");
        XmlUtils.writeDocumentToFile(doc, "payment_activation_encrypted.xml");
