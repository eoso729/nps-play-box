...
class NameVerificationReportXmlGeneratorTest {
    ...
    void testGenerateSuccessReport() {
        ...
        NameVerificationReport result = NameVerificationReportXmlGenerator.generate(dto);

        assertNotNull(result);
        assertNotNull(result.getIdVrfctnRpt());
        assertNotNull(result.getIdVrfctnRpt().getAssgnmt().getMsgId());
        ...
        assertEquals("true", result.getIdVrfctnRpt().getRpt().getVrfctn());
    ...
    void testGenerateFailureReport() {
        ...
        assertNotNull(result);
        assertEquals("false", result.getIdVrfctnRpt().getRpt().getVrfctn());
