...
export const MESSAGE_CONFIGS: Record<string, MessageConfig> = {
    ...
    sections: [
      {
        title: '1. Header & Agents',
        fields: [
          { key: 'sourceId', label: 'Instructing Agent Member ID', type: 'text', required: true, placeholder: '999057' },
          { key: 'destinationId', label: 'Instructed Agent Member ID', type: 'text', required: true, placeholder: '999012' },
        ],
      },
      {
        ...
        fields: [
          ...
          { key: 'originalMsgNmId', label: 'Original Message Name ID', type: 'text', placeholder: 'pacs.008.001.12' },
          { key: 'originalCreDtTm', label: 'Original Creation Date Time', type: 'text', placeholder: '2025-02-25T00:02:35.072Z' },
          { key: 'originalTxId', label: 'Original Transaction ID', type: 'text', required: true, placeholder: '99905820250802112346977904433112345', fullWidth: true },
          { key: 'settlementDate', label: 'Settlement Date (YYYY-MM-DD)', type: 'text', placeholder: '2025-02-25' },
        ],
      },
    ],
    prefill: {
  ...
  'pain.012': {
    ...
    sections: [
      {
        title: '1. Original Mandate Information',
        fields: [
          { key: 'originalMsgId', label: 'Original Message ID (from pain.009)', type: 'text', required: true, placeholder: '99905820251211112346125578725905163', fullWidth: true },
          { key: 'originalMsgNmId', label: 'Original Message Name ID', type: 'text', placeholder: 'pain.009.001.08' },
          { key: 'originalCreDtTm', label: 'Original Creation Date Time', type: 'text', placeholder: '2025-12-11T16:19:15.342Z' },
          { key: 'originalMandateId', label: 'Original Mandate ID', type: 'text', required: true, placeholder: 'MNDT-RCUR-00001' },
          { key: 'accepted', label: 'Acceptance Result', type: 'select', required: true, options: [
            { value: 'true', label: 'True (Accepted)' },
            { value: 'false', label: 'False (Rejected)' },
          ]},
        ],
      },
      {
        title: '2. Mandate Terms & Schedules',
        fields: [
          { key: 'sequenceType', label: 'Sequence Type', type: 'select', options: [
          ...
          { key: 'firstCollectionDate', label: 'First Collection Date', type: 'text', placeholder: '2025-09-08' },
          { key: 'finalCollectionDate', label: 'Final Collection Date', type: 'text', placeholder: '2025-12-31' },
          { key: 'trackingIndicator', label: 'Tracking Indicator', type: 'select', options: [
      ...
      {
        title: '3. Creditor & Debtor Parties',
        fields: [
          ...
          { key: 'creditorAgentMemberId', label: 'Creditor Agent Member ID', type: 'text', placeholder: '999058' },
          ...
          { key: 'debtorAgentMemberId', label: 'Debtor Agent Member ID', type: 'text', placeholder: '999057' },
        ],
      },
    ],
    prefill: {
      ...
      originalCreDtTm: '2025-12-11T16:19:15.342Z',
    ...
    sections: [
      {
        ...
        fields: [
          { key: 'initiatingPartyName', label: 'Initiating Party Name', type: 'text', placeholder: 'Debtor Bank' },
          { key: 'forwardingAgentMemberId', label: 'Forwarding Agent Member ID', type: 'text', placeholder: '999057' },
          { key: 'debtorAgentMemberId', label: 'Debtor Agent Member ID', type: 'text', placeholder: '999058' },
          { key: 'creditorAgentMemberId', label: 'Creditor Agent Member ID', type: 'text', placeholder: '999057' },
        ],
      },
      {
        title: '2. Original Activation References & Status',
        fields: [
          { key: 'originalMsgId', label: 'Original Message ID (from pain.013)', type: 'text', required: true, placeholder: '99905820260105102349998878725905163', fullWidth: true },
          { key: 'originalMsgNmId', label: 'Original Message Name ID', type: 'text', placeholder: 'pain.013.001.11' },
          { key: 'originalCreDtTm', label: 'Original Creation Date Time', type: 'text', placeholder: '2026-01-05T10:27:26.737Z' },
          { key: 'groupStatus', label: 'Group Status Code', type: 'select', required: true, options: [
            { value: 'ACCP', label: 'ACCP - Accepted' },
            { value: 'RJCT', label: 'RJCT - Rejected' },
          ]},
          { key: 'originalPmtInfId', label: 'Original Payment Info ID', type: 'text', placeholder: 'GSFPMTINF035985837' },
          { key: 'originalEndToEndId', label: 'Original End-to-End ID', type: 'text', placeholder: 'GSF035985837-E2E' },
          { key: 'transactionStatus', label: 'Transaction Status Code', type: 'select', required: true, options: [
            { value: 'ACCP', label: 'ACCP - Accepted' },
            { value: 'RJCT', label: 'RJCT - Rejected' },
          ]},
        ],
      ...
      {
        title: '3. Creditor & Debtor Accounts',
        fields: [
          { key: 'creditorName', label: 'Creditor Name', type: 'text', placeholder: 'CreditorCorp' },
          { key: 'creditorAccountNumber', label: 'Creditor Account IBAN (10-digit)', type: 'text', placeholder: '5555544443' },
          { key: 'debtorName', label: 'Debtor Name', type: 'text', placeholder: 'Debtor Customer' },
          { key: 'debtorAccountNumber', label: 'Debtor Account IBAN (10-digit)', type: 'text', placeholder: '8888899999' },
        ],
      },
    ],
    prefill: {
      ...
      originalCreDtTm: '2026-01-05T10:27:26.737Z',
      groupStatus: 'ACCP',
  ...
  'camt.052': {
    ...
    sections: [
      {
        title: '1. Message Recipient & Query Info',
        fields: [
          { key: 'messageRecipientName', label: 'Message Recipient Name', type: 'text', placeholder: 'Debtor Bank Name' },
          { key: 'messageRecipientBIC', label: 'Message Recipient BIC', type: 'text', placeholder: 'MSGRCPT' },
          { key: 'originalQueryMsgId', label: 'Original Query Message ID', type: 'text', required: true, placeholder: '99905820260302123735603795909182287', fullWidth: true },
          { key: 'originalQueryMsgNmId', label: 'Original Query Message Name ID', type: 'text', placeholder: 'camt.060.001.07' },
          { key: 'fromDateTime', label: 'From Date Time', type: 'text', placeholder: '2026-03-02T12:39:14.000Z' },
          { key: 'toDateTime', label: 'To Date Time', type: 'text', placeholder: '2026-02-24T09:03:07.000Z' },
        ],
      },
      {
        title: '2. Account & Servicer',
        fields: [
          { key: 'accountNumber', label: 'Account Number (10-digit NUBAN)', type: 'text', required: true, placeholder: '4488447166' },
          { key: 'currency', label: 'Currency Code', type: 'text', placeholder: 'NGN' },
          { key: 'schemeCode', label: 'Scheme Code', type: 'text', placeholder: '999057' },
          { key: 'accountServicerMemberId', label: 'Account Servicer Member ID', type: 'text', placeholder: '999058' },
        ],
      },
      {
        title: '3. Balance Information',
        fields: [
          { key: 'balanceType', label: 'Balance Type', type: 'text', placeholder: 'CLRG' },
          ...
          { key: 'balanceDateTime', label: 'Balance Date Time', type: 'text', placeholder: '2026-02-04T10:21:33.000Z' },
        ],
      },
    ],
    prefill: {
      messageRecipientName: 'Debtor Bank Name',
      messageRecipientBIC: 'MSGRCPT',
      ...
      fromDateTime: '2026-03-02T12:39:14.000Z',
      toDateTime: '2026-02-24T09:03:07.000Z',
      accountNumber: '4488447166',
      currency: 'NGN',
      schemeCode: '999057',
      accountServicerBIC: 'XYZBNGNLXXX',
      accountServicerMemberId: '999058',
      balanceType: 'CLRG',
      balanceAmount: 500000.00,
      creditDebitIndicator: 'CRDT',
      balanceDateTime: '2026-02-04T10:21:33.000Z',
    },
  },
  ...
  'camt.053': {
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: 'originalQueryMsgId', label: 'Original Query Message ID', type: 'text', required: true, placeholder: '99905820260302123735603795909182287', fullWidth: true },
          { key: 'originalQueryMsgNmId', label: 'Original Query Message Name ID', type: 'text', placeholder: 'camt.060.001.07' },
          { key: 'fromDateTime', label: 'From Date Time', type: 'text', placeholder: '2026-02-01T00:00:00.000Z' },
          { key: 'toDateTime', label: 'To Date Time', type: 'text', placeholder: '2026-02-27T05:59:59.000Z' },
        ],
      },
      {
        title: '2. Account & Servicer',
        fields: [
          { key: 'accountNumber', label: 'Account Number (10-digit NUBAN)', type: 'text', required: true, placeholder: '8887788778' },
          { key: 'currency', label: 'Currency Code', type: 'text', placeholder: 'NGN' },
          { key: 'schemeCode', label: 'Scheme Code', type: 'text', placeholder: '999057' },
          { key: 'accountServicerMemberId', label: 'Account Servicer Member ID', type: 'text', placeholder: '999058' },
        ],
      ...
      {
        title: '3. Balances (Opening & Closing)',
        fields: [
          { key: 'openingBalanceAmount', label: 'Opening Balance Amount', type: 'number', placeholder: '482000.00' },
          { key: 'openingBalanceCdtDbtInd', label: 'Opening Balance Credit/Debit', type: 'select', options: [
            { value: 'CRDT', label: 'CRDT - Credit' },
            { value: 'DBIT', label: 'DBIT - Debit' },
          ]},
          { key: 'closingBalanceAmount', label: 'Closing Balance Amount', type: 'number', placeholder: '482000.00' },
          { key: 'closingBalanceCdtDbtInd', label: 'Closing Balance Credit/Debit', type: 'select', options: [
            { value: 'CRDT', label: 'CRDT - Credit' },
            { value: 'DBIT', label: 'DBIT - Debit' },
          ]},
        ],
    ...
    prefill: {
      ...
      toDateTime: '2026-02-27T05:59:59.000Z',
      ...
      closingBalanceAmount: 482000.00,
    ...
    sections: [
      {
        title: '1. Group Header & Initiating Party',
        fields: [
          { key: 'initiatingPartyName', label: 'Initiating Party Name', type: 'text', placeholder: 'Musa' },
          { key: 'debtorAgentBIC', label: 'Debtor Agent BIC', type: 'text', placeholder: 'DEUTDEFF' },
          { key: 'debtorAgentMemberId', label: 'Debtor Agent Member ID', type: 'text', placeholder: '999057' },
        ],
      },
      {
        title: '2. Original Initiation References & Status',
        fields: [
          { key: 'originalMsgId', label: 'Original Message ID (from pain.001)', type: 'text', required: true, placeholder: '99905720260225192650869851166984847', fullWidth: true },
          { key: 'originalMsgNmId', label: 'Original Message Name ID', type: 'text', placeholder: 'pain.001.001.12' },
          { key: 'groupStatus', label: 'Group Status Code', type: 'select', required: true, options: [
            { value: 'ACSC', label: 'ACSC - Accepted Settlement Completed' },
            { value: 'ACCP', label: 'ACCP - Accepted' },
            { value: 'RJCT', label: 'RJCT - Rejected' },
          ]},
          { key: 'originalPmtInfId', label: 'Original Payment Information ID', type: 'text', placeholder: 'PMT-20251016-001-SINGLE' },
          { key: 'statusId', label: 'Status ID', type: 'text', placeholder: '99905774143804655117506058383208278' },
          { key: 'originalEndToEndId', label: 'Original End-to-End ID', type: 'text', placeholder: '99905774143804655117506058383208278' },
          { key: 'transactionStatus', label: 'Transaction Status Code', type: 'select', required: true, options: [
            { value: 'ACSC', label: 'ACSC - Accepted Settlement Completed' },
            { value: 'ACCP', label: 'ACCP - Accepted' },
            { value: 'RJCT', label: 'RJCT - Rejected' },
          ]},
          { key: 'statusCode', label: 'Status Reason Code (e.g. 000, AM09)', type: 'text', placeholder: '000' },
          { key: 'additionalInformation', label: 'Additional Information', type: 'text', placeholder: 'Accepted', fullWidth: true },
        ],
      },
    ],
    prefill: {
