    ...
    sections: [
      {
        ...
        fields: [
          { key: 'sourceId', label: 'Source ID', type: 'text', required: true, placeholder: '999998' },
          { key: 'destinationId', label: 'Destination ID', type: 'text', required: true, placeholder: '000058' },
          { key: 'currency', label: 'Currency', type: 'text', placeholder: 'NGN' },
        ],
      },
      {
        title: '2. Sender',
        fields: [
          { key: 'senderName', label: 'Sender Name', type: 'text', required: true, placeholder: 'ACME TECHNOLOGIES LTD', fullWidth: true },
          { key: 'senderAccountNumber', label: 'Sender Account', type: 'text', required: true, placeholder: 'NG56000110000012345678' },
          { key: 'senderAccountName', label: 'Sender Account Name', type: 'text', placeholder: 'ACME TECH CURRENT' },
        ],
      },
      {
        title: '3. Beneficiary',
        fields: [
          { key: 'beneficiaryName', label: 'Beneficiary Name', type: 'text', required: true, placeholder: 'INNOVATECH SOLUTIONS', fullWidth: true },
          { key: 'beneficiaryAccountNumber', label: 'Beneficiary Account', type: 'text', required: true, placeholder: 'NG29005800000098765432' },
          { key: 'beneficiaryAccountName', label: 'Beneficiary Account Name', type: 'text', placeholder: 'INNOVATECH CURRENT' },
        ],
      },
      {
        title: '4. Transaction',
        fields: [
          { key: 'amount', label: 'Amount (NGN)', type: 'number', required: true, placeholder: '1250000' },
          { key: 'narration', label: 'Narration', type: 'text', placeholder: 'Salary payment Jul 2026', fullWidth: true },
      ...
      },
      {
        ...
        fields: [
          { key: 'debtorAccountDesignation', label: 'Debtor Account Designation', type: 'text', placeholder: 'Personal' },
          { key: 'debtorIdType', label: 'Debtor ID Type', type: 'text', placeholder: 'BVN' },
          { key: 'debtorIdValue', label: 'Debtor ID Value', type: 'text', placeholder: '22123456789' },
          { key: 'debtorAccountTier', label: 'Debtor Account Tier', type: 'text', placeholder: 'Tier 2' },
          { key: 'transactionLocation', label: 'Transaction Location (Lat,Lng)', type: 'text', placeholder: '6.5244,3.3792' },
        ],
      },
    ],
    prefill: {
      sourceId: '999998', destinationId: '000058', currency: 'NGN',
      senderName: 'ACME TECHNOLOGIES LTD', senderAccountNumber: 'NG56000110000012345678',
      senderAccountName: 'ACME TECH CURRENT',
      beneficiaryName: 'INNOVATECH SOLUTIONS', beneficiaryAccountNumber: 'NG29005800000098765432',
      beneficiaryAccountName: 'INNOVATECH CURRENT',
      amount: 1250000, narration: 'Salary payment Jul 2026',
      channelCode: 'MOB', nameEnquiryMsgId: 'NE20260725001',
      debtorAccountDesignation: 'Personal', debtorIdType: 'BVN',
      debtorIdValue: '22123456789', debtorAccountTier: 'Tier 2',
    ...
    sections: [
      {
        title: '1. Party Identifiers',
        fields: [
          { key: 'sourceId', label: 'Source ID', type: 'text', required: true, placeholder: '999999' },
          { key: 'beneficiaryId', label: 'Beneficiary ID', type: 'text', required: true, placeholder: '999015' },
        ],
      },
      {
        title: '2. Verification Details',
        fields: [
          { key: 'partyToBeVerifiedName', label: 'Party Name to Verify', type: 'text', required: true, placeholder: 'John Developer', fullWidth: true },
          { key: 'partyToBeVerifiedAccountNumber', label: 'Account Number', type: 'text', required: true, placeholder: '1111111111' },
          { key: 'sendingPartyName', label: 'Sending Party Name', type: 'text', required: true, placeholder: 'Fidelity' },
        ],
      },
    ],
    prefill: {
      sourceId: '999999', beneficiaryId: '999015',
      partyToBeVerifiedName: 'John Developer',
